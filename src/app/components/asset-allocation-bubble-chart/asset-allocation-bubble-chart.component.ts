...
@Component({
  selector: 'app-asset-allocation-bubble-chart',
  templateUrl: './asset-allocation-bubble-chart.component.html',
  styleUrls: ['./asset-allocation-bubble-chart.component.css']
})
export class AssetAllocationBubbleChartComponent implements OnInit {
